...
lttng enable-event osd:bl_append -u -c u0
lttng add-context -u -t perf:thread:instructions -t perf:thread:cycles -t perf:thread:L1-dcache-load-misses -t perf:thread:dTLB-load-misses
